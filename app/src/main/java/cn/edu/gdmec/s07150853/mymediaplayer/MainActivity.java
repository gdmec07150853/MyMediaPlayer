package cn.edu.gdmec.s07150853.mymediaplayer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        player.setOnPreparedListener(new MediaPlayer.OnPreparedListener(){
            ...
            public void onPrepared(MediaPlayer mp) {
                ...
                if (vWidth>currDispaly.getWidth()||vHeight>currDispaly.getHeight()){
                    float wRatio = (float) vWidth/(float) currDispaly.getWidth();
                    float hRatio = (float)vHeight/(float) currDispaly.getHeight();
        ...
        currDispaly = this.getWindowManager().getDefaultDisplay();
    }
